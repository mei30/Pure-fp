...
Classpath:
<WORKSPACE>/.bloop/root/bloop-bsp-clients-classes/classes-Metals-3u1C_9jFQ96doe5tnfLsPA== [exists ], <HOME>/.cache/bloop/semanticdb/com.sourcegraph.semanticdb-javac.0.9.9/semanticdb-javac-0.9.9.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.12/scala-library-2.13.12.jar [exists ]
Options:
...
object TVShowParser {
  ...
  def parseShow(rawShow: String): Option[TvShow] = {
    for {
      ...
      yearStart <- extractYearStart(rawShow).orElse(ext@@)
